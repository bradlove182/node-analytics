...
<div class="min-h-full flex flex-col">
    <div class="h-screen min-h-0 basis-0 flex-1">
        <div class="flex h-full">
            <aside class="bg-background w-64 border-r h-full">
                <nav class="py-2">
                    <ul class="px-2 flex flex-col gap-1">
                        <li>
                            <a href="/" class="flex gap-2 items-center">
                                ...
                                <span class="font-black text-xl">Honeycomb</span>
                            </a>
                        </li>
                        <li>
                            <Button class="w-full justify-start" href="/">Home</Button>
                        </li>
                        <li>
                            <Button class="w-full justify-start" variant="ghost" on:click={logout}>
                                Logout
                            </Button>
                        </li>
                    </ul>
            ...
            <main class="bg-muted/40 h-full flex flex-col flex-1 w-full overflow-x-hidden">
                <div
                    class="bg-background flex h-12 max-h-12 items-center justify-between py-2 px-5 border-b"
                >
                    {user?.email}
                </div>
                <slot />
